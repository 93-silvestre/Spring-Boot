...
import br.com.lojagames.model.Usuario;
import br.com.lojagames.model.UsuarioLogin;
import br.com.lojagames.repository.UsuarioRepository;
import br.com.lojagames.service.UsuarioService;
...
public class UsuarioController {
	   ...
	   //buscando pelo nome do usuario
		...
		//realizando login
		@PostMapping("/login")
		public ResponseEntity<Usuario> autenticandoUsuario(@RequestBody Optional<UsuarioLogin> usuarioLogin){
		      return usuarioService.logarUsuario(usuarioLogin).map(resposta -> ResponseEntity.ok(resposta))
